...
<template>
    ...
    >
        <Avatar :hash="props.thread.messages[0].author" class="size-18 rounded border border-gray-700" />
        ...
        <div class="hidden md:flex flex-col gap-2 items-center select-none text-xs py-3 px-6 border rounded border-gray-700 text-gray-400 bg-gray-800">
            <IconHeart class="size-5" />
            <span>
                {{ forum.getMessageUpvotes(props.thread.hash, props.thread.messages[0].hash) }}
            </span>
        </div>
        <div class="hidden sm:flex flex-col gap-2 items-center select-none text-xs py-3 px-6 border rounded border-gray-700 text-gray-400 bg-gray-800">
            <IconClock class="size-5" />
            <span>
                {{ lastReply }}
            </span>
        </div>
        <div class="flex flex-col gap-2 items-center select-none text-xs py-3 px-6 border rounded border-gray-700 text-gray-400 bg-gray-800">
