    ...
    >
        ...
        <defs>
            <linearGradient id="paint0_linear_425_5107" x1="21" y1="0" x2="21" y2="42" gradientUnits="userSpaceOnUse">
                <stop stop-color="#1FD1FF"></stop>
                <stop offset="1" stop-color="#1BB8FF"></stop>
            </linearGradient>
            <radialGradient
            ...
            >
                <stop stop-color="#232DE3"></stop>
                <stop offset="1" stop-color="#232DE3" stop-opacity="0"></stop>
            </radialGradient>
            <radialGradient
            ...
            >
                <stop stop-color="#8B4DFF"></stop>
                <stop offset="1" stop-color="#8B4DFF" stop-opacity="0"></stop>
            </radialGradient>
            <radialGradient
            ...
            >
                <stop stop-color="#24D5FF"></stop>
                <stop offset="1" stop-color="#1BB8FF" stop-opacity="0"></stop>
            </radialGradient>
            <clipPath id="clip0_425_5107"><rect width="42" height="42" fill="white"></rect></clipPath>
        </defs>
    </svg>
</template>
